...
{
    /// <inheritdoc />
    public partial class AddSureServeModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeSection = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_VendorProfiles_VendorProfileId",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "IconUrl", "Name", "SortOrder" },
                values: new object[,]
                {
                    { 1, "", "Meals", 1 },
                    { 2, "", "Snacks", 2 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_VendorProfileId",
                table: "MenuItems",
